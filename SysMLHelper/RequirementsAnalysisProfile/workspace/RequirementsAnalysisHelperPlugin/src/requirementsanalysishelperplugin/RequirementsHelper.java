...
public class RequirementsHelper {
	...
	public static void main(String[] args) {
		...
		IRPModelElement theEl = m_rhpApplication.getSelectedElement();
		
		@SuppressWarnings("unchecked")
		List<IRPGraphElement> theGraphEls = m_rhpApplication.getSelectedGraphElements().toList();
 
		Logger.writeLine(theEl, "is the selected el");
		
		for (IRPGraphElement irpGraphElement : theGraphEls) {
			GeneralHelpers.dumpGraphicalPropertiesFor(irpGraphElement);
		}
	}
	...
	public static String getCreateRequirementTextForPrefixing(IRPProject inTheProject){
